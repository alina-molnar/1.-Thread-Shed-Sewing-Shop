Thread Shed Sewing Shop is a Python 3 project on Codecademy where one of the solutions follows the author's steps, and the other one is a simplified way of reaching the same goal.
